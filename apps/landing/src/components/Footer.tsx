...
export function Footer() {
  return (
    <footer className="bg-neutral-950 text-neutral-400 py-10 sm:py-12 md:py-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-12">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-neutral-500 max-w-sm leading-relaxed text-sm sm:text-base">
              Platform AI inklusif untuk membantu UMKM Indonesia mencatat transaksi, 
              memahami keuangan, dan meningkatkan omzet.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
              ...
              <li><a href="#aksesibilitas" className="hover:text-white transition-colors">Aksesibilitas</a></li>
              <li><a href="#faq" className="hover:text-white transition-colors">FAQ</a></li>
            </ul>
          </div>

          <div>
            <h3 className="text-white font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Kontak</h3>
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
              <li>
                <a href="https://wa.me/6281325956349" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors">
              ...
              <li>
                <a href="mailto:hmazka19@gmail.com" className="flex items-center gap-2 hover:text-white transition-colors">
        ...
        <div className="border-t border-neutral-800 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
          <p className="text-xs sm:text-sm text-neutral-600 text-center md:text-left">
            2025 NUSA AI. Dibuat untuk UMKM Indonesia.
          </p>
